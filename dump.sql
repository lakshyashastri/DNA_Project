...
INSERT INTO `Weapon_supported_attachments` VALUES ("Pump Shotgun", "Flashlight"), ("Pump Shotgun", "Suppressor"), ("Grenade Launcher", "Grip"), ("Grenade Launcher", "Flashlight"), ("Grenade Launcher", "Scope");
-- UNLOCK TABLES;
...
INSERT INTO `Bulk_purchase` VALUES (1, "Merryweather Security", "Special Carbine", 5000), (3, "The Lost Motorcycle Club", "Sawed-Off Shotgun", 950), (4, "Trevor Philips Enterprises", "Pump Shotgun", 20), (5, "Madrazo Cartel", "Pistol", 240), (6, "Ballas", "Knuckledusters", 500);
-- UNLOCK TABLES;
...
ALTER TABLE `Wield_weapon` ADD FOREIGN KEY (`Weapon_name`) REFERENCES `Weapon` (`Name`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Wield_weapon` ADD FOREIGN KEY (`Owner_name`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Adversary_wield` ADD FOREIGN KEY (`Adversary_name`) REFERENCES `Adversary` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Adversary_wield` ADD FOREIGN KEY (`Weapon_name`) REFERENCES `Weapon` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Collaborate_with` ADD FOREIGN KEY (`Associate1`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Collaborate_with` ADD FOREIGN KEY (`Associate2`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Collaborate_with` ADD FOREIGN KEY (`In_event`) REFERENCES `Landmark_event` (`Serial_number`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Consort` ADD FOREIGN KEY (`Associate_name`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Drive` ADD FOREIGN KEY (`Owner_name`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Drive` ADD FOREIGN KEY (`Vehicle_model`) REFERENCES `Vehicle` (`Model`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Property` ADD FOREIGN KEY (`Address_id`) REFERENCES `Address` (`Address_id`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Event_involves` ADD FOREIGN KEY (`Associate_name`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Event_involves` ADD FOREIGN KEY (`Event_number`) REFERENCES `Landmark_event` (`Serial_number`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Event_involves` ADD FOREIGN KEY (`Organisation_name`) REFERENCES `Criminal_organisation` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Hires` ADD FOREIGN KEY (`Organisation_name`) REFERENCES `Criminal_organisation` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Hires` ADD FOREIGN KEY (`Adversary_name`) REFERENCES `Adversary` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Bulk_purchase` ADD FOREIGN KEY (`Organisation_name`) REFERENCES `Criminal_organisation` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Bulk_purchase` ADD FOREIGN KEY (`Weapon_name`) REFERENCES `Weapon` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Property` ADD FOREIGN KEY (`Owner_name`) REFERENCES `Close_associate` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Weapon_supported_attachments` ADD FOREIGN KEY (`Weapon_name`) REFERENCES `Weapon_customisation_set` (`Weapon_name`)  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Weapon_customisation_set` ADD FOREIGN KEY (`Weapon_name`) REFERENCES `Weapon` (`Name`)  ON DELETE CASCADE ON UPDATE CASCADE;
